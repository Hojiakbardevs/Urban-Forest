    ...
    <div className="bg-white/70 backdrop-blur-sm rounded-lg p-4 border border-gray-200 space-y-4">
      <div className="space-y-2">
        <div className="text-xs text-gray-500">
          Coordinates: {selectedPoint.lat.toFixed(4)}, {selectedPoint.lng.toFixed(4)}
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="bg-green-50 rounded-lg p-3">
          <div className="flex items-center space-x-2 mb-1">
            ...
            <span className="text-xs font-medium text-green-700">NDVI</span>
          </div>
      ...
      <div className="bg-blue-50 rounded-lg p-3">
        <div className="flex items-center space-x-2 mb-1">
          ...
          <span className="text-xs font-medium text-blue-700">Impact Potential</span>
        </div>
        <div className="text-sm text-blue-600">
          Expected cooling: 2-4°C with proper vegetation
        </div>
      </div>
    </div>
  );
