...
const Legend: React.FC<LegendProps> = ({ className = "" }) => {
  ...
  return (
    <div
      className={`bg-white/95 backdrop-blur-md rounded-lg shadow-lg border border-white/20 p-4 min-w-64 ${className}`}>
      <div className="space-y-4">
        ...
        <div className="border-t border-gray-200 pt-3">
          ...
          <div className="flex items-center space-x-2 text-xs">
            ...
            <span className="text-gray-600">Optimal ekish hududlari</span>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 pt-3">
          <div className="flex items-start space-x-2">
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              Xaritaning istalgan joyini bosing va shu hudud uchun batafsil
              harorat tahlili hamda ekish bo‘yicha tavsiyalarni oling.
            </p>
          </div>
        </div>
      </div>
