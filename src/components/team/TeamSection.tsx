...
const teamMembers: TeamMemberData[] = [
  {
    ...
    description:
      "Urban issiqlik orollarini aniqlash uchun frontend tizimini ishlab chiqdi va joriy qildi, Python backend pipeline’larini yaratdi hamda Leaflet va Google Earth Engine integratsiyasini amalga oshirdi.",
    avatar: hojiakbar,
    technologies: [
      "React.js",
      "Python",
  ...
  },
  {
    ...
    description:
      "Sun’iy yo‘ldosh va sensor ma’lumotlaridan foydalangan holda, kengaytiriladigan ma’lumotlar pipeline’lari va bashoratli tahlil tizimlarini loyihaladi.",
    avatar: dilmurodov,
    technologies: [
      "Python",
      "Airflow",
  ...
  },
  {
    ...
    description:
      "Dasturiy ta’minot muhandisligi va interfeys dizaynini uyg‘unlashtirib, atrof-muhit ma’lumotlari uchun qulay va zamonaviy interfeyslarni ishlab chiqadi.",
    avatar: abilxanova,
  ...
  },
  {
    ...
    description:
      "Kuchli frontend dasturlash ko‘nikmalarini loyiha boshqaruvi bilan birlashtirib, interaktiv dashboardlar va jamoa ish samaradorligiga e’tibor qaratadi.",
    avatar: sulaymonov,
  ...
  },
  {
    ...
    description:
      "Frontend va backend tizimlarni yaratish va qo‘llab-quvvatlash, toza UI va ishonchli backend funksionallikni ta’minlaydi.",
    avatar: asadulloh,
    technologies: [
      "React.js",
      "Node.js",
...
const TeamSection: React.FC = () => {
  ...
  const filterOptions = [
    { value: "all", label: "All Team", count: teamMembers.length },
    {
      value: "developer",
      label: "Developers",
      count: teamMembers.filter((m) => m.category === "developer").length,
    },
    {
      value: "designer",
      label: "Designers",
      count: teamMembers.filter((m) => m.category === "designer").length,
    },
    {
      value: "data-scientist",
      label: "Data Scientists",
      count: teamMembers.filter((m) => m.category === "data-scientist").length,
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <motion.div
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Biz — atrof-muhit muammolariga sun’iy intellekt, geoma’lumotlar va
              interaktiv dizayn orqali innovatsion yondashuv olib kirayotgan
              muhandislar, olimlar va dizaynerlardan iborat jamoadamiz.
            </p>
          </motion.div>
